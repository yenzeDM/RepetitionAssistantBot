class Russian:
    ...
    CHANGE_HELP_TEXT_DAYS_BEFORE_REPETITION = '2️⃣\n\n✍️ Введите количество дней до повторения от 1️⃣ до 3️⃣0️⃣:'
    CHANGE_DAYS_POSITIVE = '✅ Вы успешно поменяли количество дней.'
    CHANGE_DAYS_NEGATIVE_TEXT = '❌ Текста нет в вашем словаре или вы допустили ошибку, попробуйте еще раз.'
    CHANGE_DAYS_NEGATIVE_NUM = '❌ Это число не доступно, пожалуйста, укажите от 1️⃣ до 3️⃣0️⃣:'
    # delete.py
