class Russian:
    ...
    CHANGE_BY_DAYS_OLD = '\n\nДля отмены команды нажмите ⚠️/cancel\n\nВ этом типе изменения по дням вы можете поменять дни у материала с одинаковым количеством дней до повторения, введите старое количество дней из вашего словаря:'
    CHANGE_BY_DAYS_NEW = 'Введите новое количество дней до повторения от 1️⃣ до 3️⃣0️⃣:'
    CHANGE_BY_DAYS_NEGATIVE = '❌ Такого количества дней нет в вашем словаре'
    CHANGE_SEVERAL = '\n\nДля отмены команды нажмите ⚠️/cancel\n\nДля изменения введите несколько фраз через запятую:\n\n_"Введите текст, который вы добавляли в первом шаге команды Addition"_'
    CHANGE_SEVERAL_POSITEIVE = ''
    CHANGE_SEVERAL_NEGATIVE = ''
    CHANGE_ONE = '\n\nДля отмены команды нажмите ⚠️/cancel\n\n'
    CHANGE_ONE_POSITIVE = ''
    CHANGE_ONE_NEGATIVE = ''
