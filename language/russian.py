class Russian:
    ...
    CHANGE_ONE = '✍ Для изменения введите один конкретный материал у которого хотите поменять дни до повторения:\n\n_"Введите текст, который вы добавляли в первом шаге команды Addition"_'
    ...
    DELETE_SEVERAL_TEXT_TO_REPEAT = '✍ Для удаления введите несколько фраз через запятую:\n\n_"Введите текст, который вы добавляли в первом шаге команды Addition"_'
...
⚠️ Для коректной работы с ботом нужно пользоваться командой /start'''
